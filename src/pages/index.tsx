          ...
          <div className="flex w-1/2 flex-col gap-7">
            ...
            <div className="flex max-w-screen-md flex-col gap-8 font-semibold">
              ...
              <p>
                ...
                amount - this made Wen the fairest and widest distributed
                airdrop ever on Solana. Emphasizing Wen is a coin for the
                people.
              </p>
              <p>
                Wen is the proud owner of the #1 and #2 cat accounts in the
                world (@shouldhavecat & @postsofcats) The mission for Wen is to
                take over mainstream audiences and onboard the masses to the
                cutest cat in crypto.
              </p>
            </div>
          ...
          <div className="flex w-1/2 flex-col gap-4">
            ...
            <div className="mt-7 space-y-1 text-xs">
              ...
              <p className="max-w-48">
                Wen is a coin with no intrinsic value or expectation of
